...
root = tk.Tk()
root.title('Your Time')
root.geometry("600x320")
root.maxsize(600, 320)
root.minsize(600, 320)
root.configure(background='#1d1d1d')

light = PhotoImage(file=)
dark = PhotoImage(file=)
...
def get_saudacao():
    ...
    saudacao.config(text='Hey, '+ nome_usuario)
...
tela.pack()
saudacao = Label(root, bg='#1d1d1d', fg='#8e27ea', font=('Montserrat', 14) )
saudacao.pack()
